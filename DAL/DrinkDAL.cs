...
{
    public class DrinkDAL : DBConnection
    {
        ...
        public DataTable GetDrinkAnalytis(DateTime fromDate, DateTime toDate, int limit)
        {
            return SQLQuery.Instance.ExecuteQuery("SP_GetDrinkAnalytics @fromDate, @toDate, @limit", new object[] { fromDate, toDate, limit });
        }
        public DataTable GetDrinkByBarcode(string barcode)
        {
            return SQLQuery.Instance.ExecuteQuery("Drink_GetByBarcode @Barcode", new object[] { barcode });
        }
